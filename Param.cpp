...
ParamFacility::ParamFacility() {

}

ParamFacility::ParamFacility(ParamFacility* pParam) {
    this->hl = pParam->hl;
    this->gamma_h = pParam->gamma_h;
    this->max_1w = pParam->max_1w;
    this->K = pParam->K;
...
ParamFacility::ParamFacility(DataFacility data, int K, double tol_lamda, int M) {
    this->K = K;
    this->tol_lamda = tol_lamda;
    this->M = M;
    hl = cpt_hl(data.T, data.m, data.eta, data.kappa, data.L);
...
double ParamFacility::h_func(vector<vector<double>> eta, vector<vector<double>> kappa, int t, int i, double x) {
    //negative eta
    double res = exp(eta[t][i] * x + kappa[t][i]);
    return res;
}

vector<vector<double>> ParamFacility::cpt_hl(int T, int m, vector<vector<double>> eta, vector<vector<double>> kappa, vector<double> L) {
    vector<vector<double>> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        vector<double> tmp;
...
vector<vector<vector<double>>> ParamFacility::cpt_gamma_h(int T, int m, int K, vector<vector<double>> eta, vector<vector<double>> kappa,
    vector<double> L, vector<double> U) {
    vector<vector<vector<double>>> res;
...
vector<double> ParamFacility::cpt_max_1w(int T, int m, int K, vector<double> b, vector<vector<double>> hl,
    vector<vector<vector<double>>> gamma_h) {
    vector<double> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        double tmp = b[iter_t];
...
vector<vector<double>> ParamFacility::cpt_Lw(int T, int m, vector<vector<double>> eta, vector<vector<double>> kappa, vector<double> U) {
    vector<vector<double>> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        vector<double> tmp;
...
vector<vector<double>> ParamFacility::cpt_Uw(int T, int m, vector<vector<double>> eta, vector<vector<double>> kappa, vector<double> L) {
    vector<vector<double>> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        vector<double> tmp;
...
vector<vector<double>> ParamFacility::cpt_Lwlog(int T, int m, vector<vector<double>> eta, vector<vector<double>> kappa, vector<double> L) {
    vector<vector<double>> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        vector<double> tmp;
...
vector<vector<double>> ParamFacility::cpt_Uwlog(int T, int m, vector<vector<double>> eta, vector<vector<double>> kappa, vector<double> U) {
    vector<vector<double>> res;
    for (int iter_t = 0; iter_t < T; iter_t++) {
        vector<double> tmp;
