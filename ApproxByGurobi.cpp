...
ApproxGurobiSolverAssortment::ApproxGurobiSolverAssortment() {

}

ApproxGurobiSolverAssortment::ApproxGurobiSolverAssortment(DataAssortment data, int K, double tol_lamda, int M) {
	this->data = data;
...
void ApproxGurobiSolverAssortment::solve(string output, int time_limit) {
	GRBEnv env = GRBEnv();
...
ApproxGurobiSolverFacility::ApproxGurobiSolverFacility() {

}

ApproxGurobiSolverFacility::ApproxGurobiSolverFacility(DataFacility data, int K, double tol_lamda, int M) {
	this->data = data;
...
void ApproxGurobiSolverFacility::solve(string output, int time_limit) {
	GRBEnv env = GRBEnv();
