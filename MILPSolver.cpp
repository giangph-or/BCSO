...
MILPSolverAssortment::MILPSolverAssortment() {

}

MILPSolverAssortment::MILPSolverAssortment(DataAssortment data, int K, double tol_lamda, int M) {
	this->data = data;
...
void MILPSolverAssortment::solve(string output, int time_limit) {
	try {
...
MILPSolverFacility::MILPSolverFacility() {

}

MILPSolverFacility::MILPSolverFacility(DataFacility data, int K, double tol_lamda, int M) {
	this->data = data;
...
void MILPSolverFacility::solve(string output, int time_limit) {
	try {
		GRBEnv env = GRBEnv(true);
		env.start();
		GRBModel model = GRBModel(env);
